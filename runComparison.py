...
# sql = "SELECT video_id FROM model_name WHERE video_id = 'BX_Dance01_01_FV_A113C177.mp4'"
...
# sql = "INSERT INTO MT_TRAINING_RESULT (play_id, capture_time, accuracy) VALUES (%s, %s, %s)"
